package lokachop.betterthanwarfare.gui.guidebook;

import lokachop.betterthanwarfare.recipe.RecipeEntryCraftingShapedWithTools;
...
public abstract class RecipePageCraftingShapedWithTools extends RecipePage<RecipeEntryCraftingShapedWithTools> {
	private final List<SlotGuidebook> slots;
	private final Map<RecipeEntryCraftingShapedWithTools, List<SlotGuidebook>> map;
	...
	protected RecipePageCraftingShapedWithTools(GuidebookSection section, List<RecipeEntryCraftingShapedWithTools> recipes) {
		super(section);
	...
	public abstract void buildSlots(List<RecipeEntryCraftingShapedWithTools> recipes);
	...
	public void renderBackground(TextureManager re, int x, int y) {
		...
		for (int i = 1; i <= this.recipes.size(); ++i) {
			RecipeEntryCraftingShapedWithTools recipe = this.recipes.get(i - 1);
	...
	public Map<RecipeEntryCraftingShapedWithTools, List<SlotGuidebook>> getMap() {
		return map;
	}
}
